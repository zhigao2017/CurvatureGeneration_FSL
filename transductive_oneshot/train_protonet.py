...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_weights', type=str, default='/home/mcislab/gaozhi/hyperbolic-image-embeddings-master/hyperbolic-image-embeddings-master_multidistanceFBPproto_metarerank/examples/fewshot/models/mini-resnet12.pth')    
...
#     set_gpu(args.gpu)
    ...
    if args.load_init_weight:
        pretrained_dict = torch.load(args.init_weights,strict=False)
    ...
    for epoch in range(1, args.max_epoch + 1):
        ...
        for i, batch in enumerate(train_loader, 1):
            ...
            torch.nn.utils.clip_grad_value_(model.encoder.parameters(),10)
            torch.nn.utils.clip_grad_value_(model.controller.parameters(),10)
            torch.nn.utils.clip_grad_value_(model.controller.parameters(),10)
